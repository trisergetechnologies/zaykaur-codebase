...
const BannerTwo = () => {
  return (
    <section className="relative w-full bg-gradient-to-r from-sky-600 to-indigo-700 py-4">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 flex flex-col-reverse lg:flex-row items-center justify-between">
        <div className="flex flex-col justify-center items-center text-center lg:text-left lg:w-1/2">
          <h2 className="text-3xl lg:text-5xl text-center font-bold text-white mt-4 leading-tight">
            ...
            <br className="hidden lg:block" /> with smart picks
          </h2>
          <p className="text-white text-lg mt-4">
            Laptops, audio, and accessories curated for productivity.
          </p>
          <Link
            href="/shop"
            className="flex items-center justify-center gap-2 mt-8 px-10 py-4 hover:ring-2 hover:ring-white hover:ring-opacity-50 text-lg font-semibold rounded-full bg-white text-sky-700 hover:bg-sky-100 transition duration-300 ease-in-out"
          >
            <ArrowRight className="mr-2" size={24} /> Browse deals
          </Link>
        </div>
        <div className="relative lg:w-1/2 lg:mt-0">
          ...
          <div className="absolute top-0 right-0 w-full h-full flex items-center justify-center animate-blob1">
            <div className="w-24 h-24 bg-white rounded-full opacity-40" />
          </div>
        </div>
      </div>
    </section>
